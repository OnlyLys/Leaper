...
const DEAD_KEY_AUTOCLOSING_PAIRS_ONLY_TEST_CASE = new TestCase({
    ...
    task: async (executor) => {
        ...
        await executor.simulateDeadKeyAutoclosingPairInsertion('""');
...
/**
 * Check whether an autoclosing pair where the opening character of the pair replaces a previewed
 * dead key is detected.
 */
export const SINGLE_CURSOR_DEAD_KEY_AUTOCLOSING_PAIR_DETECTION_TEST_GROUP = new TestGroup(
    'Dead Key Autoclosing Pair Detection',
    [
