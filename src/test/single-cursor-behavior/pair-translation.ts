...
/**
 * A collection of test cases that test whether the position of pairs for a single cursor are 
 * correctly tracked following non-deleting text edits¹ that cause them to be translated².
 * 
